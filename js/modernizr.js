...
!(function (e, t, n) {
  ...
  function d(e, n, r, a) {
    ...
    return (
      ...
      (s = n(f, e)),
      p.fake
        ? (p.parentNode.removeChild(p), (_.style.overflow = d), _.offsetHeight)
        : f.parentNode.removeChild(f),
      !!s
    );
  }
  function u(e, t) {
    if ("object" == typeof e) for (var n in e) q(e, n) && u(n, e[n]);
    else {
      e = e.toLowerCase();
      var r = e.split("."),
        a = Modernizr[r[0]];
  ...
  function v(e, t, a, o) {
    ...
    for (
      ...
      (u = !0), (H.modElem = i(v.shift())), (H.style = H.modElem.style);
    for (p = e.length, f = 0; p > f; f++)
      if (
        ...
        if (H.style[m] != g) return l(), "pfx" == t ? m : !0;
      }
    return l(), !1;
  }
  function y(e, t, n, a, o) {
    var i = e.charAt(0).toUpperCase() + e.slice(1),
      s = (e + " " + I.join(i + " ") + i).split(" ");
  ...
  (S.hasEvent = A),
    ...
    Modernizr.addTest("canvastext", function () {
      return Modernizr.canvas === !1
        ? !1
        : "function" == typeof i("canvas").getContext("2d").fillText;
    }),
  ...
  Modernizr.input = (function (t) {
    for (var n = 0, r = t.length; r > n; n++) O[t[n]] = !!(t[n] in R);
  ...
  Modernizr.addTest("svgclippaths", function () {
    return (
      !!t.createElementNS &&
      /SVGClipPath/.test(
        j.call(t.createElementNS("http://www.w3.org/2000/svg", "clipPath"))
      )
    );
  }),
    Modernizr.addTest("smil", function () {
      return (
        !!t.createElementNS &&
        /SVGAnimate/.test(
          j.call(t.createElementNS("http://www.w3.org/2000/svg", "animate"))
        )
      );
    });
  var M = "CSS" in e && "supports" in e.CSS,
    F = "supportsCSS" in e;
  Modernizr.addTest("supports", M || F);
  var I = S._config.usePrefixes ? N.split(" ") : [];
  S._cssomPrefixes = I;
  var D = (S.testStyles = d);
  D(
